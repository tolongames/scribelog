// test/logger.test.ts
import { createLogger, Logger, LogInfo, Transport } from '../src/index';
...
describe('Logger Formatting', () => {
  ...
  // --- Testy Splat Format ---
  it('should apply splat before json format', () => {
    /* OK */
  });
  it('should allow splat formatter to be used explicitly and return only message', () => {
    /* OK */
  });
